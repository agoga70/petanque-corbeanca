...
const IconEmail = () => (
  <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4-8 5-8-5V6l8 5 8-5v2z"/></svg>
);
    ...
    <footer style={{ borderTop: "2px solid #0a0a0a", background: "#0a0a0a", color: "#ffffff" }}>
      <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col gap-3">
          {[
            { href: "https://www.facebook.com/PetanqueCorbeanca", label: "Facebook", icon: <IconFacebook /> },
            { href: "https://www.instagram.com/petanque_corbeanca/", label: "Instagram", icon: <IconInstagram /> },
            { href: "https://wa.me/40730444666", label: "WhatsApp", icon: <IconWhatsApp /> },
            { href: "mailto:petanque.corbeanca@gmail.com", label: "Email", icon: <IconEmail /> },
          ].map((l) => (
            <a
              key={l.href}
              href={l.href}
