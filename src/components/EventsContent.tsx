...
type Props = { cyclingImages: string[] };

export default function EventsContent({ cyclingImages }: Props) {
  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <section style={{ borderBottom: "2px solid #0a0a0a" }}>
        <PhotoBanner images={cyclingImages} height={500} objectPosition="center top" alt="Club Sportiv Pétanque Corbeanca" />
      </section>
      ...
      {/* Bottom photo — cycling, starts halfway through so it differs from the top */}
      <section style={{ borderBottom: "2px solid #0a0a0a" }}>
        <PhotoBanner images={cyclingImages} height={500} objectPosition="center top" alt="Dracula Cup Pétanque" initialIdx={half} />
      </section>
